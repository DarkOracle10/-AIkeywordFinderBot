...
class SessionManager:
    ...
    def __init__(self, api_id: int, api_hash: str, sessions_dir: str = "sessions") -> None:
        """
    ...
    async def create_client(self, user_id: int, phone: str) -> Tuple[TelegramClient, bool]:
        """
    ...
    async def verify_code(self, user_id: int, phone: str, code: str, password: Optional[str] = None) -> Tuple[bool, str]:
        """
